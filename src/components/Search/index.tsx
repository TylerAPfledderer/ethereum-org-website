...
import { type UseDisclosureReturn, useMergeRefs } from "@chakra-ui/hooks"
import { Box, IconButtonProps, Portal, ThemeTypings } from "@chakra-ui/react"
...
export const SearchIconButton = forwardRef<HTMLButtonElement, IconButtonProps>(
  function SearchIconButton(props, ref) {
    return (
      <Button
        ref={ref}
        variant="ghost"
...
type Props = Pick<UseDisclosureReturn, "open" | "onOpen" | "onClose">

const Search = forwardRef<HTMLButtonElement, Props>(function Search(
  { open, onOpen, onClose },
  ref
) {
